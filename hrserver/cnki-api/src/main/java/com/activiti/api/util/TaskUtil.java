 ...
 */
package com.activiti.api.util;


import com.activiti.api.domain.GroupRepresentation;
    ...
    if (task.getProcessInstanceId() != null) {
      ...
      if (historicProcessInstance != null ) {
        ...
        if (flowElement != null && flowElement instanceof UserTask) {
          ...
          if ((!CollectionUtils.isEmpty(userTask.getCandidateGroups()) && userTask.getCandidateGroups().size() == 1
              && userTask.getCandidateGroups().get(0).contains("${taskAssignmentBean.assignTaskToCandidateGroups('"))
              || (!CollectionUtils.isEmpty(userTask.getCandidateUsers()) && userTask.getCandidateUsers().size() == 1
