...
import net.cnki.common.fastdfs.*;
import net.cnki.common.fastdfs.common.MyException;
import net.cnki.common.fastdfs.common.NameValuePair;
...
public class demo {
	...
	public void download(String group, String name) throws IOException, MyException {
		...
		IOUtils.write(b, new FileOutputStream(filePath + "/" + UUID.randomUUID().toString() + ".xlsx"));
